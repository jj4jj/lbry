...
class KademliaProtocol(protocol.DatagramProtocol):
    ...
    def sendRPC(self, contact, method, args, rawResponse=False):
        ...
        """
        msg = msgtypes.RequestMessage(self._node.node_id, self._node.external_ip,
                                      self._node.external_dht_node_port, method, args)
    ...
    def _sendResponse(self, contact, rpcID, response):
        ...
        """
        msg = msgtypes.ResponseMessage(rpcID, self._node.node_id, self._node.external_ip,
                                       self._node.external_dht_node_port, response)
        msgPrimitive = self._translator.toPrimitive(msg)
        encodedMsg = self._encoder.encode(msgPrimitive)
    ...
    def _sendError(self, contact, rpcID, exceptionType, exceptionMessage):
        ...
        """
        msg = msgtypes.ErrorMessage(rpcID, self._node.node_id, self._node.external_ip,
                                    self._node.external_dht_node_port, exceptionType,
                                    exceptionMessage)
        msgPrimitive = self._translator.toPrimitive(msg)
        encodedMsg = self._encoder.encode(msgPrimitive)
        self._send(encodedMsg, rpcID, (contact.address, contact.port))
